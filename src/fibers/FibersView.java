...
public class FibersView extends FrameView {
  ...
  public void showAboutBox() {
    if (aboutBox == null) {
      JFrame mainFrame = FibersApp.getApplication().getMainFrame();
      aboutBox = new FibersAboutBox(mainFrame);
      aboutBox.setLocationRelativeTo(mainFrame);
    }
    FibersApp.getApplication().show(aboutBox);
  }
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        outerPanel.setName("outerPanel"); // NOI18N

        innerPanel.setName("mainPanel"); // NOI18N
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(fibers.FibersApp.class).getContext().getResourceMap(FibersView.class);
        fileMenu.setText(resourceMap.getString("fileMenu.text")); // NOI18N
        fileMenu.setName("fileMenu"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(fibers.FibersApp.class).getContext().getActionMap(FibersView.class, this);
